            ...
            <div className="hero-content flex flex-col items-center text-center">
                <div className="max-w-md">
                    <img
                        ...
                        alt="Animated Image"
                        className="rounded-full border-4 border-white shadow-lg w-56 h-56 object-cover mx-auto"
                    />
                    <SplitText
                        text="Hello, there!"
                    ...
                    />
                    <p className="py-6 text-4xl font-semibold">
                        I am Pramod Lohra, Software developer from India
                    </p>
                    <Link to={"/contact"}><button className="btn btn-primary">Connect with me</button></Link>
                </div>
            </div>
        </div>
    );
